...
public class Main {
    public static void main(String[] args) {
        ...
        swimmer.updateSeedTime(StrokeType.FREE_KICK, new SeedPace100(118.0, CourseUnit.YARDS));  // 1:28 / 100y
        swimmer.updateSeedTime(StrokeType.DRILL, new SeedPace100(110.0, CourseUnit.YARDS));  // 1:28 / 100y
        // 3) Workout
        ...
        // 5) Sets
        warmup.addSet(new SwimSet(StrokeType.FREESTYLE, 1, yardsToMeters(400), Effort.EASY, "Perfect Freestyle"));
        warmup.addSet(new SwimSet(StrokeType.FREE_KICK, 4, yardsToMeters(50),  Effort.EASY, "Kick w/ streamline"));

        drills.addSet(new SwimSet(StrokeType.DRILL, 2, yardsToMeters(50),  Effort.ENDURANCE, "3 strokes / 6 kicks drill"));
        drills.addSet(new SwimSet(StrokeType.FREESTYLE, 1, yardsToMeters(50),  Effort.EASY,      "Apply the drill"));
        drills.addSet(new SwimSet(StrokeType.DRILL, 2, yardsToMeters(50),  Effort.ENDURANCE, "Rhythm drill"));
        drills.addSet(new SwimSet(StrokeType.FREESTYLE, 1, yardsToMeters(50),  Effort.EASY,      "Apply the drill"));

        main.addSet(new SwimSet(StrokeType.FREESTYLE, 4, yardsToMeters(50),  Effort.RACE_PACE, "USRPT style"));
        main.addSet(new SwimSet(StrokeType.FREESTYLE, 1, yardsToMeters(50),  Effort.EASY,     "Active recovery"));

        cooldown.addSet(new SwimSet(StrokeType.FREESTYLE, 4, yardsToMeters(50),  Effort.EASY, "Silent swimming"));
